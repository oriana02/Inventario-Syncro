...
-- ============================================================
-- TRIGGER: registra movimiento automático al actualizar stock_actual
-- Se activa al descontar stock por evento pedido.creado (RF-2.1)
-- NOTA: MySQL no permite modificar la misma tabla en un trigger AFTER,
--       se usa AFTER UPDATE con INSERT en movimiento_inventario.
-- ============================================================
DELIMITER $$

CREATE TRIGGER trg_producto_movimiento
...
BEGIN
    IF OLD.stock_actual != NEW.stock_actual THEN
        INSERT INTO movimiento_inventario (
            ...
            stock_anterior, stock_posterior, origen
        ) VALUES (
            NEW.id,
            CASE WHEN NEW.stock_actual < OLD.stock_actual THEN 'VENTA' ELSE 'AJUSTE_ENTRADA' END,
